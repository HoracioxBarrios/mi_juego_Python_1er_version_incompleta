...
class Personaje:
    ...
    def update_personaje(self, pisos: list[Piso]):
        for piso in pisos:
            if not self.en_aire:
                if self.colisiones_rectangulo_princial["lado_abajo"].colliderect(piso.dicc_rectangulo_y_sub_rectangulos_col["lado_arriba"]):
    ...
    def draw_personaje(self, screen, pisos:list[Piso]):
        ...
        for piso in pisos:
            screen.blit(piso.imagen_superficie, piso.rectangulo_principal)
